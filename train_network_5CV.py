...
def train_network(weights_file="weights.hdf5", classpath="Preproc/Train/",
    epochs=20, batch_size=20, val_split=0.2, tile=False, max_per_class=0):

    seed = np.random.seed(1)  # fix a number to get reproducibility; comment out for random behavior
